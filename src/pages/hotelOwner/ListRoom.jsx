...
//   },[])
  ...
  // return (
  //   <div>
  //     <Title align='left' font='outfit' title='Room Listings' subTitle='View, edit, or manage all listed rooms. keep type information uo-to-date to provide the best experience for users.'/>
  ...
  //                                   $ {item.pricePerNight}
  //                               </td>
  //                               <td className='py-3 px-4 border-t border-gray-300 text-sm text-red-500 etxt-center'>
...
//toggle availability of the room
  ...
  //       font='outfit'
  //       title='Room Listings'
  //       subTitle='View, edit, or manage all listed rooms. keep room information up-to-date to provide the best experience for users.'
  //     />
